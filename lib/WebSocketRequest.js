...
exports.WebSocketRequest = undefined;
...
_util2.default.inherits(WebSocketRequest, EventEmitter);
...
WebSocketRequest.prototype.readHandshake = function () {
    ...
    // Decode URL
    this.resourceURL = _url2.default.parse(this.resource, true);
...
WebSocketRequest.prototype.accept = function (acceptedProtocol, allowedOrigin, cookies) {
    ...
    var connection = new _WebSocketConnection.WebSocketConnection(this.socket, [], acceptedProtocol, false, this.serverConfig);
...
exports.WebSocketRequest = mod_WebSocketRequest;