...
var debug = (0, _debug2.default)('websocket:server');
...
_util2.default.inherits(WebSocketServer, EventEmitter);
...
WebSocketServer.prototype.handleUpgrade = function (request, socket) {
    var self = this;
    var wsRequest = new _WebSocketRequest.WebSocketRequest(socket, request, this.config);
    try {
    ...
    if (!this.config.autoAcceptConnections && (0, _utils.eventEmitterListenerCount)(this, 'request') > 0) {
...
exports.WebSocketServer = mod_WebSocketServer = WebSocketServer;
exports.WebSocketServer = mod_WebSocketServer;