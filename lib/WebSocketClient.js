...
_util2.default.inherits(WebSocketClient, EventEmitter);
...
WebSocketClient.prototype.connect = function (requestUrl, protocols, origin, headers, extraRequestOptions) {
    ...
    if (typeof requestUrl === 'string') {
        this.url = _url2.default.parse(requestUrl);
    } else {
    ...
    var req = this._req = (this.secure ? _https2.default : _http2.default).request(requestOptions);
    ...
    req.on('response', function (response) {
        self._req = null;
        if ((0, _utils.eventEmitterListenerCount)(self, 'httpResponse') > 0) {
...
WebSocketClient.prototype.succeedHandshake = function () {
    var connection = new _WebSocketConnection.WebSocketConnection(this.socket, [], this.protocol, true, this.config);
...
exports.WebSocketClient = mod_WebSocketClient;