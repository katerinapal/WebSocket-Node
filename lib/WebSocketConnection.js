...
var _FastBufferList = require("../vendor/FastBufferList");

var _utf8Validate = require("utf-8-validate");

var _utf8Validate2 = _interopRequireDefault(_utf8Validate);
...
function WebSocketConnection(socket, extensions, protocol, maskOutgoingPackets, config) {
    this._debug = (0, _utils.BufferingLogger)('websocket:connection', ++idCounter);
    ...
    this.bufferList = new _FastBufferList.BufferList();

    // Prepare for receiving first frame
    this.currentFrame = new _WebSocketFrame.WebSocketFrame(this.maskBytes, this.frameHeader, this.config);
...
_util2.default.inherits(WebSocketConnection, EventEmitter);
...
WebSocketConnection.prototype.processReceivedData = function () {
    ...
    if (!frame.addData(this.bufferList)) {
        this._debug('-- insufficient data for frame');return;
    }
...
WebSocketConnection.prototype.handleSocketError = function (error) {
    ...
    if ((0, _utils.eventEmitterListenerCount)(this, 'error') > 0) {
...
WebSocketConnection.prototype.processFrame = function (frame) {
    ...
    switch (frame.opcode) {
        ...
        case 0x01:
            ...
            if (this.assembleFragments) {
                if (frame.fin) {
                    if (!(0, _utf8Validate2.default)(frame.binaryPayload)) {
                ...
                if (frame.fin) {
                    ...
                    switch (opcode) {
                        ...
                        case 0x01:
                            ...
                            if (!(0, _utf8Validate2.default)(binaryPayload)) {
                                this.drop(WebSocketConnection.CLOSE_REASON_INVALID_DATA, 'Invalid UTF-8 Data Received');
                                return;
                            }
                            this.emit('message', {
...
WebSocketConnection.prototype.sendUTF = function (data, cb) {
    ...
    var frame = new _WebSocketFrame.WebSocketFrame(this.maskBytes, this.frameHeader, this.config);
...
WebSocketConnection.prototype.fragmentAndSend = function (frame, cb) {
    ...
    for (var i = 1; i <= numFragments; i++) {
        var currentFrame = new _WebSocketFrame.WebSocketFrame(this.maskBytes, this.frameHeader, this.config);
...
exports.WebSocketConnection = mod_WebSocketConnection;