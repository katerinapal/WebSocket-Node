...
function BufferList(opts) {
    ...
    self.forEach = function (fn) {
        if (!head.buffer) return (0, _utils.bufferAllocUnsafe)(0);
    ...
    self.join = function (start, end) {
        ...
        var big = (0, _utils.bufferAllocUnsafe)(end - start);
        var ix = 0;
    ...
    self.joinInto = function (targetBuffer, targetStart, sourceStart, sourceEnd) {
        if (!head.buffer) return new _utils.bufferAllocUnsafe(0);
...
_util2.default.inherits(BufferList, EventEmitter);
exports.BufferList = mod_BufferList;