...
(0, _tape2.default)('W3CWebSockets adding event listeners with ws.onxxxxx', function (t) {
  var counter = 0;
  ...
  (0, _startEchoServer.startEchoServer)(function (err, echoServer) {
    ...
    var ws = new _W3CWebSocket.W3CWebSocket('ws://localhost:8080/');
...
(0, _tape2.default)('W3CWebSockets adding event listeners with ws.addEventListener', function (t) {
  var counter = 0;
  var message = 'This is a test message.';
